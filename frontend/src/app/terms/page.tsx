...
export const metadata = {
  title: "الشروط والأحكام | وصلني",
  description: "اقرأ الشروط والأحكام الخاصة بمنصة وصلني للتسوق الإلكتروني.",
}
...
const SECTIONS = [
  {
    ...
    content: `باستخدامك لموقع "وصلني" أو تطبيقاته، فإنك توافق على الالتزام بهذه الشروط والأحكام بالكامل. إذا كنت لا توافق على أي من هذه الشروط، يُرجى عدم استخدام خدماتنا. نحتفظ بحق تعديل هذه الشروط في أي وقت، وسيتم إخطارك بأي تغييرات جوهرية عبر البريد الإلكتروني أو إشعار على المنصة.`,
  },
  {
    id: "services",
    title: "٢. وصف الخدمة",
    content: `تُقدّم منصة "وصلني" خدمة تسوق إلكتروني تتيح لك تصفح المنتجات وشراءها عبر الإنترنت مع خيار الدفع عند الاستلام. نطاق التشغيل الحالي داخل قرية ميت العامل فقط، وقريبًا القرى المجاورة. قد تتغير المنتجات المتاحة أو أسعارها في أي وقت دون إشعار مسبق.`,
  },
  {
    id: "account",
  ...
  },
  {
    ...
    content: `لا تتحمل منصة "وصلني" المسؤولية عن أي أضرار غير مباشرة أو عرضية أو تبعية ناتجة عن استخدام خدماتنا. مسؤوليتنا القصوى في أي حالة محدودة بقيمة الطلب الذي نشأت عنه المطالبة. نحن لسنا مسؤولين عن أي تأخير أو فشل ناتج عن قوة قاهرة أو ظروف خارجة عن سيطرتنا.`,
  },
  {
    id: "law",
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-gray-500 leading-relaxed max-w-2xl">
                  يُرجى قراءة هذه الشروط بعناية قبل استخدام منصة "وصلني". استخدامك للمنصة يعني موافقتك التامة على جميع هذه الشروط.
                </p>
