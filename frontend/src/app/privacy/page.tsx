...
export const metadata = {
  title: "سياسة الخصوصية | وصلني",
  description: "تعرّف على كيفية جمع واستخدام وحماية بياناتك الشخصية في منصة وصلني.",
}
...
const SECTIONS = [
  {
    id: "intro",
    title: "١. مقدمة",
    content: `تُقدّر منصة "وصلني" خصوصيتك وتلتزم بحماية بياناتك الشخصية. توضح هذه السياسة كيفية جمع معلوماتك واستخدامها وحمايتها عند استخدامك لموقعنا أو تطبيقنا. بالاستمرار في استخدام خدماتنا، فإنك توافق على الممارسات الموضحة في هذه السياسة.`,
  },
  {
    id: "data-collected",
