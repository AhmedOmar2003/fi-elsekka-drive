...
const ADMIN_MANUAL_TRANSITIONS: Record<TripStatus, readonly TripStatus[]> = {
    ...
    driver_arrived: ["trip_started", "waiting_for_return", "cancelled"],
    waiting_for_return: ["trip_started", "completed", "cancelled"],
    trip_started: ["waiting_for_return", "completed", "cancelled"],
    completed: [],
    cancelled: [],
};
